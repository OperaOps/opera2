...
export const treatmentVisualAssetPlan: TreatmentAssetEntry[] = [
  ...
  /* ============================ 13. coronary-stent ======================== */
  {
    assetId: 'coronary-stent-1',
    useCaseId: 'coronary-stent',
    sceneNumber: 1,
    recommendedFileName: 'heart-coronary-overview.mp4',
    assetType: 'medical-render',
    closeupLevel: 'wide',
    visualDescription:
      'A realistic 3D human heart that zooms in to a coronary artery narrowed by plaque.',
    whatPatientLearns: 'A buildup has narrowed one of the heart’s arteries, making blood flow harder.',
    exactImageGenerationPrompt: `Hyper-realistic 3D anatomical render of a beating human heart in deep navy space, zooming toward one coronary artery that is visibly narrowed by plaque. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slow orbit and push-in toward a coronary artery narrowed by plaque on a realistic beating heart, deep navy background. ${STYLE}.`,
    stockSearchTerms: ['coronary artery narrowing 3d', 'heart blocked artery render', 'atherosclerosis heart animation', 'coronary plaque visualization', 'beating heart artery zoom', 'cardiac artery blockage'],
    overlayLabels: [{ text: 'Narrowed artery', x: 50, y: 42 }],
    animationTreatment: 'Slow orbit then push-in toward the narrowed artery.',
    personalizationOverlay: 'This is what is happening in your heart, Bruno — explained simply.',
    voiceover:
      "Let's start with your heart, Bruno. This is a coronary artery — and right here, a buildup has narrowed it, making it harder for blood to get through.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'coronary-stent-2',
    useCaseId: 'coronary-stent',
    sceneNumber: 2,
    recommendedFileName: 'artery-plaque-narrowing.mp4',
    assetType: 'medical-render',
    closeupLevel: 'macro',
    visualDescription: 'A close-up inside the artery showing plaque narrowing the channel.',
    whatPatientLearns: 'Up close, the narrowing inside the artery is what the procedure will open back up.',
    exactImageGenerationPrompt: `Hyper-realistic interior view of a coronary artery with yellow plaque narrowing the channel, glistening arterial wall. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slow glide into a coronary artery to the plaque blockage narrowing the channel. ${STYLE}.`,
    stockSearchTerms: ['inside artery plaque', 'coronary blockage closeup', 'arterial plaque macro', 'narrowed artery interior', 'atherosclerosis closeup', 'artery channel narrowing'],
    overlayLabels: [{ text: 'The blockage', x: 50, y: 46 }],
    animationTreatment: 'Slow forward glide settling on the blockage.',
    personalizationOverlay: 'This is the spot we open up, Bruno — nothing more complicated than that.',
    voiceover:
      'Up close, you can see the narrowing inside the artery. The whole goal of the procedure is simply to open this back up.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'coronary-stent-3',
    useCaseId: 'coronary-stent',
    sceneNumber: 3,
    recommendedFileName: 'catheter-advancing.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A thin catheter with a balloon and crimped stent positioned across the blockage.',
    whatPatientLearns: 'A thin, flexible tube gently guides a tiny balloon and stent to the narrowed spot.',
    exactImageGenerationPrompt: `Hyper-realistic side cutaway of a horizontal coronary artery with a balloon catheter and crimped stent positioned across the plaque, coaxial with the vessel. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second side cutaway, balloon catheter with crimped stent advancing horizontally into position across the blockage. ${STYLE}.`,
    stockSearchTerms: ['balloon catheter artery', 'stent delivery catheter', 'angioplasty catheter render', 'crimped stent balloon', 'coronary catheter positioning', 'guidewire artery'],
    overlayLabels: [{ text: 'Tiny balloon + stent', x: 50, y: 30 }],
    animationTreatment: 'Catheter eases into position across the blockage.',
    personalizationOverlay: 'It is gentle and guided, Bruno — you are resting comfortably the whole time.',
    voiceover:
      'Through a thin, flexible tube, your care team gently guides a tiny balloon — with a small mesh stent around it — right to the narrowed spot.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'coronary-stent-4',
    useCaseId: 'coronary-stent',
    sceneNumber: 4,
    recommendedFileName: 'balloon-inflating.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'The balloon inflates and expands the stent against the artery walls.',
    whatPatientLearns: 'Gently inflating the balloon opens the artery and expands the stent against the wall.',
    exactImageGenerationPrompt: `Hyper-realistic side cutaway of a coronary artery, balloon inflating and expanding a diamond-mesh stent against the walls, plaque flattening. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second side cutaway, balloon inflates and the mesh stent expands against the artery walls, widening the channel. ${STYLE}.`,
    stockSearchTerms: ['balloon angioplasty inflate', 'stent expanding artery', 'balloon stent deployment', 'coronary stent expand', 'angioplasty inflation render', 'stent against artery wall'],
    overlayLabels: [{ text: 'Opens the artery', x: 50, y: 30 }],
    animationTreatment: 'Balloon inflates; stent expands against the walls.',
    personalizationOverlay: 'A gentle, steady opening, Bruno — controlled and precise.',
    voiceover:
      'The balloon is then gently inflated, which opens the artery and expands the little stent against the wall.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'coronary-stent-5',
    useCaseId: 'coronary-stent',
    sceneNumber: 5,
    recommendedFileName: 'stentplacedandshown.mp4',
    assetType: 'medical-render',
    closeupLevel: 'macro',
    visualDescription: 'The balloon is removed and the expanded stent stays, holding the artery open.',
    whatPatientLearns: 'The balloon comes out and the stent stays — a small scaffold holding the artery open.',
    exactImageGenerationPrompt: `Hyper-realistic side cutaway of a coronary artery with an expanded silver diamond-mesh stent lining the walls, balloon removed, channel open. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second side cutaway, balloon withdraws leaving the expanded mesh stent holding the artery open. ${STYLE}.`,
    stockSearchTerms: ['coronary stent placed', 'stent in artery render', 'deployed stent mesh', 'stent holding artery open', 'metal stent artery wall', 'angioplasty stent result'],
    overlayLabels: [{ text: 'The stent stays', x: 50, y: 30 }],
    animationTreatment: 'Balloon clears; the stent holds the artery open.',
    personalizationOverlay: 'A tiny scaffold that quietly does its job, Bruno — for the long run.',
    voiceover:
      'The balloon comes out, and the stent stays behind — a small scaffold that holds the artery open for good.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'coronary-stent-6',
    useCaseId: 'coronary-stent',
    sceneNumber: 6,
    recommendedFileName: 'bloodflowthrustentandzoomoutbacktoheart.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'wide',
    visualDescription: 'Blood flows freely through the stented artery, then pulls back to the beating heart.',
    whatPatientLearns: 'Blood flows freely again and the heart gets what it needs — that is the whole procedure.',
    exactImageGenerationPrompt: `Hyper-realistic blood flowing through a stented coronary artery, then pulling out to a calm beating heart in deep navy space. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second blood flowing through the stent then a smooth pull-out to the whole healthy beating heart. ${STYLE}.`,
    stockSearchTerms: ['restored blood flow heart', 'stented artery blood flow', 'healthy coronary flow', 'beating heart restored', 'blood flow stent render', 'cardiac flow restored'],
    overlayLabels: [{ text: 'Flow restored', x: 50, y: 40 }],
    animationTreatment: 'Blood flows through the stent; camera pulls out to the heart.',
    personalizationOverlay: 'And that is the whole thing, Bruno — done to help you feel better.',
    voiceover:
      'And just like that, blood flows freely again, and your heart gets what it needs. That is the whole procedure, Bruno — done to help you feel better.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  ...
  /* ============================ 14. lasik ================================ */
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 1,
    recommendedFileName: 'lasik-suite.mp4',
    assetType: 'stock-video',
    closeupLevel: 'wide',
    visualDescription: 'A calm modern laser eye-surgery suite with the patient resting on the bed.',
    whatPatientLearns: 'LASIK happens in a calm, modern suite — you are awake and comfortable the whole time.',
    exactImageGenerationPrompt: `Photorealistic calm modern laser eye-surgery suite, patient relaxed on a reclining bed beneath a laser system, soft lighting. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slow push-in across a calm modern LASIK suite toward the patient and laser. ${STYLE}.`,
    stockSearchTerms: ['lasik surgery suite', 'laser eye surgery room', 'refractive suite modern', 'eye surgery laser bed', 'ophthalmology laser room', 'lasik clinic interior'],
    overlayLabels: [{ text: 'A calm, modern suite', x: 50, y: 80 }],
    animationTreatment: 'Slow push-in from the room toward the patient and laser.',
    personalizationOverlay: 'It is calm and modern, Maya — you are awake and comfortable the whole time.',
    voiceover:
      "Let's start with the room, Maya. LASIK happens in a calm, modern suite — you're awake, resting comfortably, and the whole thing takes just a few minutes.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 2,
    recommendedFileName: 'lasik-docking.mp4',
    assetType: 'stock-video',
    closeupLevel: 'medium',
    visualDescription: 'The laser lowers over the eye and a gentle eyelid holder keeps the eye open.',
    whatPatientLearns: 'Numbing drops make the eye comfortable, and a gentle holder keeps it open so you needn’t worry about blinking.',
    exactImageGenerationPrompt: `Photorealistic LASIK docking — laser head lowering over a numbed eye held open by a soft eyelid speculum, surgeon's gloved hands. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second medium shot, the laser docking over the eye as a gentle eyelid holder is placed. ${STYLE}.`,
    stockSearchTerms: ['lasik eyelid speculum', 'laser docking eye', 'eye held open surgery', 'lasik numbing drops', 'eye surgery speculum', 'femtosecond laser eye'],
    overlayLabels: [{ text: 'Numb & gently held open', x: 50, y: 78 }],
    animationTreatment: 'Laser descends; a gentle holder keeps the eye open.',
    personalizationOverlay: 'Numbing drops first, Maya — your eye stays completely comfortable.',
    voiceover:
      "First, numbing drops make your eye completely comfortable, and a small, gentle holder keeps it open so you don't have to worry about blinking.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 3,
    recommendedFileName: 'lasik-eye-closeup.mp4',
    assetType: 'stock-video',
    closeupLevel: 'close-up',
    visualDescription: 'The laser aligns over the open eye while the patient looks at a soft fixation light.',
    whatPatientLearns: 'You simply look at a soft light while the laser lines up perfectly over your eye.',
    exactImageGenerationPrompt: `Photorealistic close-up of a numbed open eye under a laser, a soft fixation light to focus on. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second close-up, laser aligning over the open eye with a soft fixation light. ${STYLE}.`,
    stockSearchTerms: ['lasik eye closeup', 'fixation light eye surgery', 'laser aligned over eye', 'open eye laser surgery', 'eye tracking lasik', 'cornea laser closeup'],
    overlayLabels: [{ text: 'Just look at the light', x: 50, y: 80 }],
    animationTreatment: 'Laser settles into alignment; soft fixation light glows.',
    personalizationOverlay: 'Nothing for you to do, Maya — just look at the soft light and relax.',
    voiceover:
      "You simply look at a soft light while the laser lines up perfectly over your eye. There's nothing for you to do but relax.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 4,
    recommendedFileName: 'lasik-flap-creation.mp4',
    assetType: 'medical-render',
    closeupLevel: 'macro',
    visualDescription: 'A femtosecond laser painlessly creates a thin flap — a ring of microscopic bubbles forms.',
    whatPatientLearns: 'A first laser painlessly creates a thin protective layer — you might feel light pressure, no pain.',
    exactImageGenerationPrompt: `Hyper-realistic macro of a cornea as a femtosecond laser forms a ring of microscopic bubbles outlining a thin flap. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second macro, a femtosecond laser tracing a ring of micro-bubbles to create a corneal flap. ${STYLE}.`,
    stockSearchTerms: ['femtosecond laser flap', 'corneal flap bubbles', 'lasik flap creation', 'cornea microbubbles laser', 'lasik femto laser', 'corneal flap macro'],
    overlayLabels: [{ text: 'A thin, gentle layer', x: 50, y: 80 }],
    animationTreatment: 'A ring of micro-bubbles forms around the iris.',
    personalizationOverlay: 'Painless, Maya — maybe a little pressure for a few seconds, nothing more.',
    voiceover:
      'A first laser painlessly creates a thin, protective layer on the surface — you might feel a little pressure, but no pain at all.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 5,
    recommendedFileName: 'lasik-laser-reshape.mp4',
    assetType: 'medical-render',
    closeupLevel: 'macro',
    visualDescription: 'A cool blue laser gently reshapes the cornea, with an eye-tracking reticle holding it centered.',
    whatPatientLearns: 'A second laser gently reshapes the cornea to correct your vision — a few painless seconds, eye tracked throughout.',
    exactImageGenerationPrompt: `Hyper-realistic macro of a cool blue excimer laser beam with a glowing eye-tracking reticle reshaping the cornea. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second macro, a blue laser pulsing on the cornea with a concentric eye-tracking reticle of light. ${STYLE}.`,
    stockSearchTerms: ['excimer laser cornea', 'lasik vision correction laser', 'cornea reshaping laser', 'eye tracking laser reticle', 'blue laser eye surgery', 'refractive laser macro'],
    overlayLabels: [{ text: 'Reshaping to correct vision', x: 50, y: 80 }],
    animationTreatment: 'Rhythmic laser pulses, beam centered by a tracking reticle.',
    personalizationOverlay: 'Just a few seconds, Maya — painless, and your eye is tracked the whole time.',
    voiceover:
      'Then a second laser gently reshapes the cornea to correct your vision — just a few seconds, completely painless, with your eye tracked the whole time.',
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    ...
    useCaseId: 'lasik',
    sceneNumber: 6,
    recommendedFileName: 'lasik-result-eye.mp4',
    assetType: 'stock-video',
    closeupLevel: 'close-up',
    visualDescription: 'The finished eye is clear and bright, blinking calmly — vision restored.',
    whatPatientLearns: 'The layer is smoothed back into place and that’s it — most people see more clearly within hours.',
    exactImageGenerationPrompt: `Photorealistic front-on macro of a pristine, crystal-clear eye with a bright catchlight, blinking calmly. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second front-on macro of a clear bright finished eye, one slow natural blink. ${STYLE}.`,
    stockSearchTerms: ['clear bright eye closeup', 'lasik result eye', 'healthy eye blink macro', 'crisp clear vision eye', 'bright eye catchlight', 'restored vision eye'],
    overlayLabels: [{ text: 'Clear, calm, done', x: 50, y: 80 }],
    animationTreatment: 'One slow natural blink; the eye settles bright and clear.',
    personalizationOverlay: 'And that is the whole thing, Maya — most people see clearly within hours.',
    voiceover:
      "That layer is smoothed back into place, and that's it — most people notice clearer vision within hours. That's the whole procedure, Maya.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },

  /* ============================ cosmetic-veneers (Jessica) ==================== */
  {
    assetId: 'cosmetic-veneers-1',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 1,
    recommendedFileName: 'veneers-smile-overview.mp4',
    assetType: 'stock-video',
    closeupLevel: 'close-up',
    visualDescription: 'A relaxed natural smile in close-up — the front teeth today, with small gaps and slightly uneven color.',
    whatPatientLearns: 'This is your smile today — veneers will gently even out the small gaps and color.',
    exactImageGenerationPrompt: `Photorealistic close-up of a relaxed adult smile, front teeth with small gaps and slightly uneven shade. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slow push-in on a relaxed natural smile, front teeth with small gaps and uneven shade. ${STYLE}.`,
    stockSearchTerms: ['natural smile before veneers', 'front teeth small gaps', 'uneven tooth color smile', 'cosmetic dentistry before', 'close up smile teeth', 'patient smile education'],
    overlayLabels: [{ text: 'Your smile today', x: 50, y: 80 }],
    animationTreatment: 'Slow push-in toward the front teeth.',
    personalizationOverlay: "This is where we're starting, Jessica — and here's how we'll perfect it.",
    voiceover:
      "This is your smile today, Jessica — lovely already, with just a couple of small gaps and a little unevenness in color you've mentioned bug you in photos. Here's how we'll gently perfect it.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-2',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 2,
    recommendedFileName: 'veneers-shell-reveal.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A single wafer-thin translucent porcelain veneer shell rotating in soft light.',
    whatPatientLearns: 'A veneer is a wafer-thin porcelain shell — light passes through it just like natural enamel.',
    exactImageGenerationPrompt: `Product macro of one wafer-thin translucent porcelain veneer shell floating on deep navy. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slow rotation of a single wafer-thin translucent porcelain veneer shell. ${STYLE}.`,
    stockSearchTerms: ['porcelain veneer shell', 'thin dental veneer macro', 'translucent veneer render', 'veneer product shot', 'dental porcelain shell', 'veneer close up'],
    overlayLabels: [{ text: 'Thinner than a fingernail', x: 50, y: 80 }],
    animationTreatment: 'Gentle rotation, light glowing through the thin edges.',
    personalizationOverlay: "It looks completely real once it's on, Jessica — never fake.",
    voiceover:
      "A veneer is a wafer-thin shell of porcelain, thinner than a fingernail. Light passes right through it, just like natural enamel, so your smile looks completely real — never fake.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-3',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 3,
    recommendedFileName: 'veneers-shade-and-scan.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A shade guide fans beside the teeth, then a scanner wand sweeps soft blue light across them.',
    whatPatientLearns: 'We match the exact shade and take a quick digital scan — no drills, just light.',
    exactImageGenerationPrompt: `3D dental model with a shade guide fan and an intraoral scanner projecting blue structured light. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second shade match then scanner wand sweeping blue structured light across the teeth. ${STYLE}.`,
    stockSearchTerms: ['dental shade guide', 'intraoral scanner teeth', 'digital dental scan', 'tooth shade matching', 'dental scanner blue light', 'cosmetic dentistry scan'],
    overlayLabels: [{ text: 'Shade match & digital scan', x: 50, y: 80 }],
    animationTreatment: 'Shade tabs compare, then the scanner glides across the teeth.',
    personalizationOverlay: 'Custom-made to fit you exactly, Jessica — no guesswork.',
    voiceover:
      "First, we match the exact shade and take a quick digital scan — no drills, just light. That's how each veneer is custom-made to fit your teeth perfectly and blend right in.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-4',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 4,
    recommendedFileName: 'veneers-minimal-prep.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A fine tool gently refines only the flat front surface of one tooth; the tooth stays whole.',
    whatPatientLearns: 'Only a whisper-thin layer is removed from the front — your tooth stays tall and strong.',
    exactImageGenerationPrompt: `3D dental model, a slim tool gently refining the flat front surface of one tooth, tooth intact. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second slim tool gently smoothing only the front surface of one tooth, tooth stays whole. ${STYLE}.`,
    stockSearchTerms: ['veneer tooth preparation', 'minimal enamel prep', 'tooth front surface prep', 'dental veneer prep animation', 'conservative tooth prep', 'veneer preparation 3d'],
    overlayLabels: [{ text: 'Only a whisper-thin layer', x: 50, y: 80 }],
    animationTreatment: 'Slim tool glides gently across the front surface.',
    personalizationOverlay: 'Your own tooth stays tall and strong underneath, Jessica.',
    voiceover:
      "Next, we gently prepare the front of each tooth, removing only a whisper-thin layer — just enough to make room. Your own tooth stays tall and strong underneath the whole time.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-5',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 5,
    recommendedFileName: 'veneers-etch-and-bond.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A fine brush glazes a clear layer then a glossy bonding layer onto the prepared tooth.',
    whatPatientLearns: 'The front is prepared with a rinse and a thin layer of adhesive so the veneer bonds securely.',
    exactImageGenerationPrompt: `3D single tooth model, a fine brush applying a clear etch then glossy bonding layer. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second brush applying clear etch, rinse to matte, then glossy bonding layer on one tooth. ${STYLE}.`,
    stockSearchTerms: ['dental bonding adhesive', 'tooth etching veneer', 'dental etch and bond', 'veneer bonding step', 'adhesive dentistry macro', 'bonding brush tooth'],
    overlayLabels: [{ text: 'Prepared to bond securely', x: 50, y: 80 }],
    animationTreatment: 'Brush strokes lay down etch then a glossy adhesive layer.',
    personalizationOverlay: 'This is what makes your new smile last for years, Jessica.',
    voiceover:
      "Then the front surface is gently prepared so the veneer bonds securely — a quick rinse and a thin layer of adhesive. This is what makes your new smile last for years.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-6',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 6,
    recommendedFileName: 'veneers-seat-first.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'Fine tweezers press a single veneer onto the front face of one tooth, seated flush at the gumline.',
    whatPatientLearns: 'Each veneer is placed onto the front of the tooth and eased flush into position.',
    exactImageGenerationPrompt: `Frontal macro, tweezers pressing one veneer flat onto the front face of a single tooth. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second frontal macro, tweezers placing one veneer flush onto the front of a single tooth. ${STYLE}.`,
    stockSearchTerms: ['veneer placement tweezers', 'seating dental veneer', 'veneer bonded to tooth', 'placing porcelain veneer', 'veneer application macro', 'dental veneer seated'],
    overlayLabels: [{ text: 'Placed flush at the gumline', x: 50, y: 80 }],
    animationTreatment: 'The veneer eases onto the front of the tooth and seats flush.',
    personalizationOverlay: 'Smooth and flush at the gumline, Jessica — just like a natural tooth.',
    voiceover:
      "Now the first veneer goes on. It's placed onto the front of the tooth and eased gently into position, sitting flush and smooth right at the gumline.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-7',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 7,
    recommendedFileName: 'veneers-seat-brighten.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'As a veneer settles, the tooth turns visibly brighter, smoother, and more even.',
    whatPatientLearns: 'As each veneer settles, that tooth turns brighter, smoother, and beautifully even.',
    exactImageGenerationPrompt: `Frontal macro, a front tooth turning brighter and more even as its veneer settles. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second frontal macro, one tooth brightening and evening as its veneer settles into place. ${STYLE}.`,
    stockSearchTerms: ['tooth brightening veneer', 'veneer before after tooth', 'whiter even tooth', 'veneer transformation macro', 'brighter smile veneer', 'cosmetic tooth reveal'],
    overlayLabels: [{ text: 'Brighter and even', x: 50, y: 80 }],
    animationTreatment: 'The tooth brightens and evens as the veneer settles.',
    personalizationOverlay: 'You can already see the difference, Jessica.',
    voiceover:
      "As each veneer settles into place, you can already see the difference — that tooth turns brighter, smoother, and beautifully even.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-8',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 8,
    recommendedFileName: 'veneers-cure-bond.mp4',
    assetType: 'short-motion-video',
    closeupLevel: 'macro',
    visualDescription: 'A blue curing light sweeps across the veneers, setting the bond in seconds.',
    whatPatientLearns: 'A soft blue light sets the bond in seconds, locking each veneer firmly in place.',
    exactImageGenerationPrompt: `Macro of a blue LED curing light setting a veneer bond on the front teeth. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second blue LED curing light sweeping across the veneers, firming the bond. ${STYLE}.`,
    stockSearchTerms: ['dental curing light', 'blue led curing veneer', 'bonding cure light teeth', 'veneer curing macro', 'dental blue light bond', 'curing wand teeth'],
    overlayLabels: [{ text: 'Set in seconds', x: 50, y: 80 }],
    animationTreatment: 'The blue curing light glides across, firming the bond.',
    personalizationOverlay: 'Strong, sealed, and ready for every photo, Jessica.',
    voiceover:
      "A soft blue light sets the bond in just seconds, locking each veneer firmly in place — strong, sealed, and ready for every photo on your big day.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
  {
    assetId: 'cosmetic-veneers-9',
    useCaseId: 'cosmetic-veneers',
    sceneNumber: 9,
    recommendedFileName: 'veneers-finished-smile.mp4',
    assetType: 'stock-video',
    closeupLevel: 'close-up',
    visualDescription: 'The finished smile — bright, even, and completely natural.',
    whatPatientLearns: 'The finished smile is bright, even, and completely natural — your own smile, perfected.',
    exactImageGenerationPrompt: `Photorealistic finished smile, front teeth bright and even with seamless natural veneers. ${STYLE}.`,
    exactVideoGenerationPrompt: `8-second ease-back to a full finished smile, bright even natural veneers. ${STYLE}.`,
    stockSearchTerms: ['finished veneers smile', 'bright even smile after', 'natural veneers result', 'cosmetic dentistry after', 'perfect smile veneers', 'happy patient smile'],
    overlayLabels: [{ text: 'Bright, even, natural', x: 50, y: 80 }],
    animationTreatment: 'Slow ease-back revealing the complete finished smile.',
    personalizationOverlay: "Completely your own, Jessica — just brighter and even.",
    voiceover:
      "And there it is, Jessica — your new smile: bright, even, and completely your own. Dr. Bennett and the whole team can't wait for you to see it in the mirror on your big day.",
    priority: 'high',
    fallbackIfMissing: 'asset-slot-only',
  },
];
