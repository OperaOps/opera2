...
export const storyboardsPart1: Record<string, StoryboardScene[]> = {
  ...
  'post-discharge-recovery': [
    {
      sceneTitle: 'Hi, Robert',
      narration:
        "Hi Robert, it's your care team. We know discharge paperwork can feel like a lot, and we know you like things kept simple and clear. So this is the short version — the few things that matter most as you settle back home.",
      onScreenText: 'Hi Robert — the simple version.',
      visualType: 'title-card',
      motionDirection: 'Name fades up over a calm, homey gradient',
      transition: 'Cross-dissolve into the concerns scene',
      iconName: 'Home',
      lottieSearchKeyword: 'calm home welcome',
      customAnimationIdea:
        'Name settles in, then a small home icon rises softly beneath it',
      backgroundStyle: 'Warm sand-to-slate gradient with gentle light',
      safetyBoundary: 'Education only — reflects approved discharge instructions, no new advice',
      personalizationReason:
        'Greets by name and honors his preference for simple, clear summaries',
      durationSec: 9,
      patientPersonalization:
        'Acknowledges Robert’s dislike of long paperwork and promises the short version',
      assetSearchTerms: ['home welcome animation', 'warm gradient intro', 'simple home icon'],
      codedAnimationIdea:
        'Name staggers up; a home SVG eases up (y:16→0) with a soft settle',
      avoidShowing: ['dense paperwork walls', 'alarming language', 'clinical complexity'],
    },
    {
      sceneTitle: 'We kept it simple',
      narration:
        "We know the packet you got was long, and that's frustrating when you just want to know what to do. So we pulled out the essentials — and you can always get a clean printed copy. Nothing here is new; it's your discharge plan, made readable.",
      onScreenText: '“The paperwork is a lot.”',
      visualType: 'quote-card',
      motionDirection: 'A thick stack shrinks into a single tidy card',
      transition: 'Card dissolves into the recovery timeline',
      iconName: 'FileText',
      lottieSearchKeyword: 'simplify paperwork document',
      customAnimationIdea:
        'A tall stack of pages collapses smoothly into one clean summary card with a print icon',
      backgroundStyle: 'Muted slate with a warm spotlight on the card',
      safetyBoundary: 'Summarizes approved discharge content only — adds nothing new',
      personalizationReason:
        'Addresses Robert’s confusion with long paperwork and his print preference',
      durationSec: 10,
      patientPersonalization:
        'Names the long-packet frustration and offers a clean printed copy he prefers',
      assetSearchTerms: ['paper stack to card', 'simplify document ui', 'printable summary'],
      codedAnimationIdea:
        'Stack of page SVGs scales/stacks down into one card; print icon fades in beside it',
      avoidShowing: ['new medical advice', 'overwhelming text', 'clinical jargon'],
    },
    {
      sceneTitle: 'Your recovery, step by step',
      narration:
        "Here's the easy roadmap: Day 1 is rest and getting comfortable. The first week is gentle routine — eating, moving a little, sleeping. Then a follow-up to check how you're doing. One step at a time, that's all.",
      onScreenText: 'Day 1 → Week 1 → Follow-up',
      visualType: 'journey-timeline',
      motionDirection: 'A calm timeline draws left to right with three soft milestones',
      transition: 'Timeline recedes into the hospital-to-home scene',
      iconName: 'CalendarClock',
      lottieSearchKeyword: 'recovery timeline home',
      customAnimationIdea:
        'Three milestone nodes light up in order along a gentle line, each with a friendly icon',
      backgroundStyle: 'Warm sand canvas with soft shadows',
      safetyBoundary: 'General recovery framing from approved discharge guidance only',
      personalizationReason:
        'Gives Robert the simple, sequential view he prefers over dense text',
      durationSec: 12,
      clinicalVisualCategory: 'recovery-home-care',
      clinicalVisualDirection:
        'A calm Day 1 → Week 1 → Follow-up home-recovery timeline with friendly milestone icons',
      realWorldConceptShown:
        'How recovery generally unfolds at home over the first days and week',
      safeMedicalVisualStyle:
        'Soft, reassuring timeline graphics; home-comfort tone; nothing clinical or alarming',
      patientPersonalization:
        'Presents recovery as simple one-step-at-a-time milestones for a simplicity-preferring patient',
      assetSearchTerms: ['home recovery timeline', 'day one week one milestones', 'gentle recovery roadmap'],
      codedAnimationIdea:
        'SVG timeline draws (pathLength); three milestone icons pop in sequence with a soft bounce',
      avoidShowing: ['wounds', 'medical procedures', 'alarming recovery imagery'],
    },
    {
      sceneTitle: 'From hospital to home',
      narration:
        "Coming home, the most important thing is knowing who to call. Your care team's number is right here, your follow-up clinic is here, and your son visits on weekends — so you've got people. You're not on your own with this.",
      onScreenText: 'Who to contact',
      visualType: 'comparison',
      motionDirection: 'A soft arc connects a hospital icon to a home icon, contacts appearing along it',
      transition: 'Scene fades into the red-flag call scene',
      iconName: 'MapPin',
      lottieSearchKeyword: 'hospital to home transition',
      customAnimationIdea:
        'A gentle path links a hospital to a cozy home; contact cards (care team, clinic, son) fade in along it',
      backgroundStyle: 'Warm gradient with a calm hospital-to-home illustration',
      safetyBoundary: 'Contact/orientation info only — reflects approved discharge plan',
      personalizationReason:
        'Names his weekend-visiting son so a patient living alone feels supported',
      durationSec: 11,
      clinicalVisualCategory: 'care-setting',
      clinicalVisualDirection:
        'A calm hospital-to-home transition showing who to contact, with a warm clinic-room feel',
      realWorldConceptShown:
        'The handoff from hospital care to home, and who is available to help',
      safeMedicalVisualStyle:
        'Warm, orienting illustration; reassuring; no clinical or distressing imagery',
      patientPersonalization:
        'Specifically references his son’s weekend visits to counter living-alone worry',
      assetSearchTerms: ['hospital to home illustration', 'who to contact card', 'support network ui'],
      codedAnimationIdea:
        'An SVG arc path-draws hospital→home; contact cards fade in along the path in sequence',
      avoidShowing: ['emergency-room distress', 'isolation framing', 'clinical equipment'],
    },
    {
      sceneTitle: 'Call your team if…',
      narration:
        "Your discharge plan lists a few things to watch for — and if any of them happen, the right move is simple: call your care team. You don't have to figure it out alone. When in doubt, just call; that's exactly what they're there for.",
      onScreenText: 'When in doubt, call.',
      visualType: 'checklist',
      motionDirection: 'A short list of calm watch-for cues appears, each beside a phone icon',
      transition: 'List softens into the follow-up appointment scene',
      iconName: 'HeartPulse',
      lottieSearchKeyword: 'call care team phone calm',
      customAnimationIdea:
        'Each watch-for cue fades in with a steady phone icon; a gentle “just call” button settles at the end',
      backgroundStyle: 'Calm slate card, steady and non-alarming',
      safetyBoundary: 'Lists approved discharge red-flags calmly; routes to care team, no new advice',
      personalizationReason:
        'Frames red-flags reassuringly for a patient who lives alone and dislikes complexity',
      durationSec: 11,
      patientPersonalization:
        'Reassures a solo-living patient that the action is always simply to call his team',
      assetSearchTerms: ['call your doctor ui', 'when in doubt call', 'calm reminder card'],
      codedAnimationIdea:
        'Watch-for cues stagger in; a steady (non-pulsing) “Call your team” button fades in last to stay calm',
      avoidShowing: ['scary symptom imagery', 'blood or wounds', 'panic-inducing red alerts'],
    },
    {
      sceneTitle: 'Your follow-up visit',
      narration:
        "Last piece: your follow-up appointment. It's how your team checks you're healing well. We can book a time that works, and if your son drives you on a weekend, even better. We'll send a clear reminder so it's easy to remember.",
      onScreenText: 'Book your follow-up',
      visualType: 'portal-mockup',
      motionDirection: 'A portal screen rises, a follow-up date glows on a simple calendar',
      transition: 'Mockup fades toward the closing card',
      iconName: 'CalendarClock',
      lottieSearchKeyword: 'follow up appointment calendar',
      customAnimationIdea:
        'A clean calendar highlights a weekend slot; a “We’ll remind you” note fades in below',
      backgroundStyle: 'Soft warm gradient with a floating device frame',
      safetyBoundary: 'Scheduling support only — reflects approved follow-up plan',
      personalizationReason:
        'Offers a weekend slot so his son can drive him to the appointment',
      durationSec: 10,
      patientPersonalization:
        'Suggests a weekend follow-up tied to his son’s weekend visits and a clear reminder',
      assetSearchTerms: ['follow up booking ui', 'weekend appointment slot', 'reminder note card'],
      codedAnimationIdea:
        'Calendar cell glows with an animated ring; “We’ll remind you” caption fades up beneath',
      avoidShowing: ['urgent deadlines', 'pressure tactics', 'clinical complexity'],
    },
    {
      sceneTitle: 'A gentle reminder',
      narration:
        "Everything here comes straight from your discharge plan, Robert — it's not new advice, and it can't replace your care team. If anything's unclear, just call them. Rest up, take it one step at a time, and you've got this.",
      onScreenText: 'For education only',
      visualType: 'closing-card',
      motionDirection: 'Disclaimer settles center over a calm hold',
      transition: 'Slow fade to brand mark',
      ...
      customAnimationIdea:
        'Disclaimer fades over a slow-breathing shield; a synthetic-demo badge appears in the corner',
      backgroundStyle: 'Warm slate gradient, minimal and restful',
      safetyBoundary: 'Explicit education-only disclaimer; reflects approved discharge content only',
      personalizationReason:
        'Closes warmly by name and reinforces calling the team for anything unclear',
      durationSec: 8,
      patientPersonalization:
        'Signs off by name with an encouraging, one-step-at-a-time message',
      assetSearchTerms: ['education disclaimer card', 'calm shield outro', 'soft brand close'],
      codedAnimationIdea:
        'Disclaimer text fades up; shield breathes; corner badge eases in last',
      avoidShowing: ['new medical advice', 'alarming red-flag imagery', 'replacement-for-care claims'],
    },
  ],

  /* ===================================================================== */
  /* 5) MEDICATION JOURNEY — Linda, 59, reads online, tempted to stop      */
  /* ===================================================================== */
  'medication-journey': [
    {
      sceneTitle: 'Hi, Linda',
