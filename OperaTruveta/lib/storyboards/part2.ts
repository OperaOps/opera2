...
export const storyboardsPart2: Record<string, StoryboardScene[]> = {
  ...
  /* =====================================================================
   * LASIK — Maya, 34, nervous about a laser near her eye
   * ===================================================================== */
  'lasik': [
    {
      sceneTitle: 'Hi, Maya',
      narration:
        "Hi Maya, it's your care team. We know the idea of a laser near your eye sounds scary — so let's walk through exactly what happens during LASIK, calmly and clearly.",
      onScreenText: "Hi Maya — let's walk through it.",
      visualType: 'title-card',
      motionDirection: 'Name fades up over a calm, clear motif',
      transition: 'Cross-dissolve',
      iconName: 'Eye',
      lottieSearchKeyword: 'calm clear vision welcome',
      customAnimationIdea: "Maya's name settles over a soft, clear-eye motif.",
      backgroundStyle: 'Soft blue gradient with warm light',
      safetyBoundary: 'Education only — no assessment of Maya’s case.',
      personalizationReason: 'Greets Maya and gently names the fear.',
      durationSec: 11,
    },
    {
      sceneTitle: 'We hear you',
      narration:
        "You told us the thought of a laser on your eye freaks you out — and that's completely understandable. The best way to feel calmer is to actually see how gentle and quick it is, so that's exactly what we'll do.",
      onScreenText: '“A laser on my eye freaks me out.”',
      visualType: 'quote-card',
      motionDirection: 'Quote eases in; a reassuring underline draws beneath it',
      transition: 'Slide-left',
      iconName: 'MessageSquare',
      lottieSearchKeyword: 'reassurance calm',
      customAnimationIdea: 'A worried quote softens as a calm line draws beneath it.',
      backgroundStyle: 'Muted blue with a warm spotlight',
      safetyBoundary: 'Acknowledges feelings; makes no clinical claims.',
      personalizationReason: 'Validates Maya’s specific fear.',
      durationSec: 12,
    },
    {
      sceneTitle: 'Questions worth asking',
      narration:
        "Before your procedure, it can help to jot a few questions down. Will it hurt? How long does it take? When will I see clearly? Bring these, and your team will walk you through every one.",
      onScreenText: 'Questions to bring',
      visualType: 'question-list',
      motionDirection: 'Checklist items tick in one by one',
      transition: 'Fade',
      ...
      lottieSearchKeyword: 'question checklist',
      customAnimationIdea: 'Each question writes on with a soft check beside it.',
      backgroundStyle: 'Calm blue with soft accents',
      safetyBoundary: 'Prompts discussion; gives no medical answers.',
      personalizationReason: 'Helps an anxious first-timer feel prepared.',
      durationSec: 11,
    },
    {
      ...
      lottieSearchKeyword: 'care team message',
      customAnimationIdea: 'A “reply to talk it through” prompt pulses softly.',
      backgroundStyle: 'Soft blue with a warm key light',
      safetyBoundary: 'Encourages a care-team conversation, not self-care.',
      personalizationReason: 'Reassures Maya she has support.',
      durationSec: 10,
    },
    {
      sceneTitle: 'A calm close',
      narration:
        "This video is here to help you understand the procedure, Maya — it isn't medical advice, and your care team is the best place for your specific questions. Thanks for taking a few minutes for your eyes.",
      onScreenText: 'For education only',
      visualType: 'closing-card',
      motionDirection: 'Text settles center; disclaimer eases in last',
      transition: 'Fade-to-card',
      iconName: 'ShieldCheck',
      lottieSearchKeyword: 'calm closing clear eye',
      customAnimationIdea: 'A clear eye settles as the disclaimer fades in.',
      backgroundStyle: 'Deep blue, minimal and restful',
      safetyBoundary: 'Explicit education-only disclaimer.',
      personalizationReason: 'Closes warmly by name.',
      durationSec: 9,
    },
