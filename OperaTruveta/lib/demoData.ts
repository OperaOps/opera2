...
const baseUseCases: DemoUseCase[] = [
  ...
  // 4 ─────────────────────────────────────────────────────────────────────
  {
    ...
    summary:
      'Walks Jake from his ACL reconstruction through every phase of knee rehab — so the road back to soccer feels clear, not endless.',
    accent: 'teal',
    patient: {
      name: 'Jake',
      age: 27,
      ...
      lifeContext: {
        occupation: 'Account executive; plays Sunday-league soccer',
        livingSituation: 'Third-floor walk-up apartment; his girlfriend helped the first week',
        schedule: 'Desk job, back at the laptop quickly; physical therapy twice a week',
        preferences: ['Straight answers', 'Wants the why behind each phase', 'Visual learner'],
        notes:
          'Tore his ACL planting on a turf field. Deeply motivated to get back to soccer — the risk is pushing too fast, not too slow.',
      },
      concerns: [
        {
          quote: "Is my knee ever going to feel stable again?",
          acknowledgedAs:
            'Showing how the graft becomes his new ACL and how each rehab phase rebuilds the stability around it.',
        },
        {
          quote: "When do I actually get back on the field?",
          acknowledgedAs:
            'Explaining that return-to-play is a milestone decision his care team makes phase by phase — never a date promised in a video.',
        },
      ],
      goals: [
        'Understand what was actually done in surgery',
        'Know what each rehab phase is for',
        'Have good questions ready for his physical therapist',
      ],
      barriers: [
        'Three flights of stairs at his apartment',
        'Impatience — tempted to test the knee ahead of the plan',
      ],
      synthetic: true,
    },
    clinicalContext: {
      trigger:
        'Jake had ACL reconstruction after a soccer injury and is starting the phased rehab plan his surgeon and physical therapist approved.',
      journeyStage: 'Post-surgery / early rehabilitation',
      careTeamContext:
        'The care team wants Jake to understand the purpose of each rehab phase so he trusts the pace instead of racing it.',
      appointmentHistory: ['ACL reconstruction completed', 'First physical therapy session scheduled'],
    },
    approvedContent: {
      title: 'ACL Reconstruction Recovery — Patient Rehab Guide',
      owner: 'Meridian Orthopedics & Sports Medicine Patient Education Board (synthetic)',
      summary:
        'Plain-language guide to what ACL reconstruction does, how the graft heals, what each rehab phase is for, and how return-to-activity decisions are made with the care team.',
      version: 'v2.1',
      lastReviewed: '2026-05-20',
    },
    evidenceTheme: {
      theme:
        'Across large real-world populations, patients who understand and stay with their phased rehab plan tend to report more confidence through recovery.',
      educationalRelevance:
        'Used only to explain why the plan is phased — never to predict Jake’s timeline or outcome.',
      provenance:
        'Truveta-style de-identified recovery-journey themes, summarized for education and reviewed by the care team.',
    },
    personalizationSignals: [
      {
        label: 'Soccer is the goal',
        value: 'Sunday-league player; return to the field is what motivates him',
        source: 'patient-provided',
        appliedAs: 'Frames every phase as a step on the road back to soccer.',
      },
      {
        label: 'Tempted to push too fast',
        value: 'High motivation, low patience',
        source: 'care-team-provided',
        appliedAs: 'Explains why early phases are gentle on purpose, so slow reads as strategy, not setback.',
      },
      {
        label: 'Third-floor walk-up',
        value: 'Stairs are part of his daily life from day one',
        source: 'patient-provided',
        appliedAs: 'Acknowledges the stairs directly with a calm, practical note.',
      },
      {
        label: 'Wants the why',
        value: 'Trusts a plan when he understands the reason behind it',
        source: 'patient-provided',
        appliedAs: 'Every phase is explained with its purpose, not just its exercises.',
      },
    ],
    script: {
      opening: 'Hi Jake — surgery’s done, the new ligament is in, and now the comeback starts.',
      fullNarration:
        'Hi Jake — surgery’s done, the new ligament is in, and now the comeback starts. This is your recovery plan, made simple: what happened inside your knee, and what each phase of rehab is actually for. You’ve asked the two questions every athlete asks: will my knee feel stable again, and when do I get back on the field? Both answers live in the same place — the phases of your rehab plan. Here’s the plan at a glance. Phase one calms the knee down and gets it moving again. Phase two rebuilds the strength around it. Phase three brings back running, cutting, and jumping. You move forward when your knee is ready — milestones, not dates. The early weeks feel slow on purpose: the graft is still becoming part of you, so gentle is the strategy, not a setback. Take the stairs at your apartment one at a time for now, and let the plan set the pace. And bring your therapist good questions: what should this phase feel like, what tells us I’m ready for the next one, and what should I ease up on if the knee swells? You know your body — the plan works best as a conversation.',
      closing:
        'One phase at a time, Jake — your surgeon and your therapist are with you the whole way back to the field.',
      disclaimer: 'This video is educational and does not replace medical advice from your care team.',
    },
    storyboard: [
      {
        sceneTitle: 'The comeback starts',
        narration:
          'Hi Jake — surgery’s done, the new ligament is in, and now the comeback starts. This is your recovery plan, made simple: what happened inside your knee, and what each phase of rehab is actually for.',
        onScreenText: 'Your road back, made simple',
        visualType: 'title-card',
        motionDirection: 'Title fades up; a subtle path motif draws forward beneath it',
        transition: 'Cross-dissolve',
        iconName: 'Route',
        lottieSearchKeyword: 'recovery journey path',
        customAnimationIdea: 'A winding path draws from a hospital icon toward a small soccer field.',
        backgroundStyle: 'Teal-to-slate gradient with soft grain',
        safetyBoundary: 'Education only — restates the approved rehab plan, promises nothing.',
        personalizationReason: 'Opens with the comeback framing that motivates Jake.',
        durationSec: 11,
      },
      {
        sceneTitle: 'Your two big questions',
        narration:
          'You’ve asked the two questions every athlete asks: will my knee feel stable again, and when do I get back on the field? Both answers live in the same place — the phases of your rehab plan.',
        onScreenText: '“Will it hold? When do I play?”',
        visualType: 'quote-card',
        motionDirection: 'Two question cards rise side by side, then merge into one plan card',
        transition: 'Slide-left',
        iconName: 'MessageSquare',
        lottieSearchKeyword: 'two questions cards',
        customAnimationIdea: 'Both question cards fold together into a single “the plan” card.',
        backgroundStyle: 'Deep slate with teal accents',
        safetyBoundary: 'No stability promise, no return date — routes both to the phased plan.',
        personalizationReason: 'Names Jake’s exact worries in his own framing.',
        durationSec: 14,
      },
      {
        sceneTitle: 'The phases at a glance',
        narration:
          'Here’s the plan at a glance. Phase one calms the knee down and gets it moving again. Phase two rebuilds the strength around it. Phase three brings back running, cutting, and jumping. You move forward when your knee is ready — milestones, not dates.',
        onScreenText: 'Calm & move → Strength → Sport',
        visualType: 'journey-timeline',
        motionDirection: 'A three-phase timeline draws left to right, each node lighting in turn',
        transition: 'Fade',
        iconName: 'CalendarClock',
        lottieSearchKeyword: 'phased timeline milestones',
        customAnimationIdea: 'Three milestone nodes light up in sequence; the last shows a small soccer ball.',
        backgroundStyle: 'Slate with a single teal timeline',
        safetyBoundary: 'Phases described by purpose only — no personal timeline predicted.',
        personalizationReason: 'Gives the visual learner one clear map of the whole road.',
        durationSec: 16,
      },
      {
        sceneTitle: 'Slow is the strategy',
        narration:
          'The early weeks feel slow on purpose: the graft is still becoming part of you, so gentle is the strategy, not a setback. Take the stairs at your apartment one at a time for now, and let the plan set the pace.',
        onScreenText: 'Gentle now protects the graft',
        visualType: 'checklist',
        motionDirection: 'A shield motif settles over a knee icon; a stairs icon gets a calm checkmark',
        transition: 'Cross-dissolve',
        iconName: 'ShieldCheck',
        lottieSearchKeyword: 'protect shield checklist',
        customAnimationIdea: 'A small staircase icon animates one careful step at a time.',
        backgroundStyle: 'Slate with warm teal glow',
        safetyBoundary: 'Restates approved early-phase guidance; no new instructions invented.',
        personalizationReason: 'Speaks directly to his impatience and his third-floor walk-up.',
        durationSec: 14,
      },
      {
        sceneTitle: 'Questions for your therapist',
        narration:
          'And bring your therapist good questions: what should this phase feel like, what tells us I’m ready for the next one, and what should I ease up on if the knee swells? You know your body — the plan works best as a conversation.',
        onScreenText: 'Good questions to bring to PT',
        visualType: 'question-list',
        motionDirection: 'Three questions type in one by one as a checklist',
        transition: 'Slide-up',
        iconName: 'ClipboardList',
        lottieSearchKeyword: 'question checklist notes',
        customAnimationIdea: 'Each question gently underlines as it lands.',
        backgroundStyle: 'Slate with soft teal highlights',
        safetyBoundary: 'Stays in “ask your care team” framing; gives no clinical answers.',
        personalizationReason: 'Turns Jake’s drive into partnership with his PT instead of freelancing.',
        durationSec: 14,
      },
      {
        sceneTitle: 'Warm close',
        narration:
          'One phase at a time, Jake — your surgeon and your therapist are with you the whole way back to the field. This video is educational and does not replace medical advice from your care team.',
        onScreenText: 'One phase at a time',
        visualType: 'closing-card',
        motionDirection: 'Gentle zoom-out; disclaimer eases in beneath',
        transition: 'Fade-to-card',
        iconName: 'HeartPulse',
        lottieSearchKeyword: 'calm encouragement close',
        customAnimationIdea: 'The path motif from the opening completes, ending at a small goal post.',
        backgroundStyle: 'Teal-to-slate gradient, calm',
        safetyBoundary: 'Educational disclaimer present and narrated.',
        personalizationReason: 'Closes on the field — the image that keeps Jake in the plan.',
        durationSec: 10,
      },
    ],
    visualAssetPlan: {
      palette: 'Teal and slate with warm sunlit accents',
      keyVisuals: ['Knee anatomy with glowing ACL', 'Graft placement render', 'Three-phase rehab timeline', 'Golden-hour return to the field'],
      titleCard: 'Path-to-field motif on teal gradient, confident type',
      iconStyle: 'Rounded line icons, two-tone teal',
    },
    motionPlan: {
      pacing: 'steady and encouraging',
      signatureTransition: 'Cross-dissolve with a forward drift',
      motionNotes: 'Motion always moves forward along the path — progress without urgency.',
      renderTargets: ['Remotion', 'Framer Motion', 'Lottie'],
    },
    cta: {
      sms:
        'Hi Jake — your knee recovery plan, explained phase by phase, plus questions to bring to PT. Watch when you get a minute: [link]',
      email: {
        subject: 'Your ACL recovery plan, phase by phase',
        body:
          'Hi Jake,\n\nWe made a short video that walks through exactly what happened in your knee surgery and what each phase of rehab is for — from calming the knee down to getting back on the field. It also has good questions to bring to your physical therapist.\n\nWatch here: [link]\n\nOne phase at a time. Your care team is with you the whole way.',
      },
      portal:
        'A video walkthrough of your ACL recovery plan is ready. It explains your surgery, each rehab phase, and questions to bring to physical therapy.',
    },
    compliance: [
      { label: 'No diagnosis', status: 'pass', detail: 'Explains a completed, care-team-managed treatment; no clinical determination.' },
      { label: 'No treatment recommendation', status: 'pass', detail: 'Describes the approved rehab plan; recommends nothing new.' },
      { label: 'No return-to-play promise', status: 'pass', detail: 'Frames return as a milestone decision made by the care team.' },
      { label: 'No patient-specific outcome prediction', status: 'pass', detail: 'Uses population-level context only.' },
      { label: 'Educational disclaimer present', status: 'pass', detail: 'Disclaimer shown on the closing card and narrated.' },
      { label: 'Human review required', status: 'pass', detail: 'Routed for care-team review before send.' },
    ],
    safetyBoundary: {
      doesNotDo: [
        'Does not promise a return-to-play date or a specific outcome',
        'Does not add exercises or instructions beyond the approved plan',
        'Does not assess Jake’s pain, swelling, or progress',
        'Does not clear him for any activity — that is his care team’s call',
      ],
      does: [
        'Explains what the reconstruction did in plain language',
        'Explains the purpose of each rehab phase',
        'Encourages pacing and protects against rushing',
        'Provides questions to bring to physical therapy',
      ],
      explanation:
        'This asset is education about a treatment Jake has already received and a rehab plan his care team owns. It builds understanding and patience — every progression decision stays entirely with his surgeon and physical therapist.',
    },
    outputs: ['video', 'portal', 'sms', 'email'],
    estimatedRuntimeSec: 96,
  },
